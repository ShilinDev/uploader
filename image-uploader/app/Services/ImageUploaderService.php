...
class ImageUploaderService
{
     ...
     */
    public function uploadFormData($files): \Illuminate\Http\JsonResponse
    {
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function uploadJson($json): \Illuminate\Http\JsonResponse
    {
     ...
     */
    public function saveImage($file, $filename): void
    {
        $image = new Image();
     ...
     * @param $extension
     */
    public function saveBase64Image($filename, $extension): void
    {
        $image = new Image();
